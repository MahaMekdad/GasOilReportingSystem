...
@Component({
  selector: 'app-budget-actual-ch',
  templateUrl: './budget-actual-ch.component.html',
  styleUrls: ['./budget-actual-ch.component.css']
})
export class BudgetActualChComponent implements OnInit {
  ...
  constructor(private _concessionsBudgetsService: ConcessionsBudgetsService, public dialogRef: MatDialogRef<BudgetActualChComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
