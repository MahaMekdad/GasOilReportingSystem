 ...
 */
export interface ProductionGeneralInfoWithNamesResponse { 
    id?: number;
    wellName?: string;
    fieldName?: string;
    concessionName?: string;
    initialProdDate?: Date;
    initialType?: ProductionGeneralInfoWithNamesResponse.InitialTypeEnum;
    initialProduct?: ProductionGeneralInfoWithNamesResponse.InitialProductEnum;
    initialLiftType?: ProductionGeneralInfoWithNamesResponse.InitialLiftTypeEnum;
    initStatus?: ProductionGeneralInfoWithNamesResponse.InitStatusEnum;
    monitoringSystem?: ProductionGeneralInfoWithNamesResponse.MonitoringSystemEnum;
    currentWellType?: ProductionGeneralInfoWithNamesResponse.CurrentWellTypeEnum;
    currentWellTypeDate?: Date;
    currentProduct?: ProductionGeneralInfoWithNamesResponse.CurrentProductEnum;
    currentStatus?: ProductionGeneralInfoWithNamesResponse.CurrentStatusEnum;
    runtime?: number;
    currentLiftType?: ProductionGeneralInfoWithNamesResponse.CurrentLiftTypeEnum;
    currentLiftTypeDate?: Date;
    powerSourceType?: ProductionGeneralInfoWithNamesResponse.PowerSourceTypeEnum;
    powerSource?: string;
    processionPlant?: ProductionGeneralInfoWithNamesResponse.ProcessionPlantEnum;
}
export namespace ProductionGeneralInfoWithNamesResponse {
