 ...
 */
import { AllFluidLevelMeasurementResponse } from './allFluidLevelMeasurementResponse';

export interface GetAllFluidLevelMeasurement extends Array<AllFluidLevelMeasurementResponse> { 
}