 ...
 */
import { ProductionGeneralInfoWithNamesResponse } from './productionGeneralInfoWithNamesResponse';

export interface GetProductionGeneralInfoWithNames extends Array<ProductionGeneralInfoWithNamesResponse> { 
}