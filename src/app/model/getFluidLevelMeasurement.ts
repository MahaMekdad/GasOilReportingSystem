 ...
 */
import { FluidLevelMeasurementResponse } from './fluidLevelMeasurementResponse';

export interface GetFluidLevelMeasurement extends Array<FluidLevelMeasurementResponse> { 
}