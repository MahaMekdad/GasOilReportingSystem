...
/**
 * Model for the ProductionGeneralInfo object info for returns {post, put, and patch requests)
 */
export interface ProductionGeneralInfoRequest { 
    initialProdDate?: Date;
    initialType?: ProductionGeneralInfoRequest.InitialTypeEnum;
    initialProduct?: ProductionGeneralInfoRequest.InitialProductEnum;
    initialLiftType?: ProductionGeneralInfoRequest.InitialLiftTypeEnum;
    initStatus?: ProductionGeneralInfoRequest.InitStatusEnum;
    monitoringSystem?: ProductionGeneralInfoRequest.MonitoringSystemEnum;
    currentWellType?: ProductionGeneralInfoRequest.CurrentWellTypeEnum;
    currentWellTypeDate?: Date;
    currentProduct?: ProductionGeneralInfoRequest.CurrentProductEnum;
    currentStatus?: ProductionGeneralInfoRequest.CurrentStatusEnum;
    runtime?: number;
    currentLiftType?: ProductionGeneralInfoRequest.CurrentLiftTypeEnum;
    currentLiftTypeDate?: Date;
    powerSourceType?: ProductionGeneralInfoRequest.PowerSourceTypeEnum;
    powerSource?: string;
    processionPlant?: ProductionGeneralInfoRequest.ProcessionPlantEnum;
}
export namespace ProductionGeneralInfoRequest {
