 ...
 */
import { AllProductionGeneralInfoWithNamesResponse } from './allProductionGeneralInfoWithNamesResponse';

export interface GetAllProductionGeneralInfoWithNames extends Array<AllProductionGeneralInfoWithNamesResponse> { 
}