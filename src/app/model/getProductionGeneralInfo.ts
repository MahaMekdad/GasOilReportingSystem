 ...
 */
import { ProductionGeneralInfoResponse } from './productionGeneralInfoResponse';

export interface GetProductionGeneralInfo extends Array<ProductionGeneralInfoResponse> { 
}